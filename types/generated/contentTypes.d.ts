...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    firstName: Attribute.String;
    lastName: Attribute.String;
    fav_properties: Attribute.Relation<
      'plugin::users-permissions.user',
      'manyToMany',
      'api::property.property'
    >;
    contacted_properties: Attribute.Relation<
      'plugin::users-permissions.user',
      'manyToMany',
      'api::property.property'
    >;
    searches: Attribute.Relation<
      'plugin::users-permissions.user',
      'manyToMany',
      'api::search.search'
    >;
...
export interface ApiCompanySubmissionCompanySubmission
  extends Schema.CollectionType {
  collectionName: 'company_submissions';
  info: {
    singularName: 'company-submission';
    pluralName: 'company-submissions';
    displayName: 'Company submission';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    status: Attribute.Enumeration<['seen', 'contacted', 'ignored']> &
      Attribute.DefaultTo<'ignored'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::company-submission.company-submission',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiGlobalGlobal extends Schema.SingleType {
  ...
  attributes: {
    ...
    palette: Attribute.Component<'theme.palette'> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiPropertyProperty extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    slug: Attribute.UID;
    bath: Attribute.Integer & Attribute.Required & Attribute.DefaultTo<1>;
    bed: Attribute.Integer & Attribute.Required & Attribute.DefaultTo<1>;
    area: Attribute.Integer & Attribute.Required;
    ...
    hasConditions: Attribute.Boolean & Attribute.DefaultTo<false>;
    description: Attribute.RichText &
      ...
      >;
    purpose: Attribute.Enumeration<['buy', 'rent', 'commercial']> &
      Attribute.DefaultTo<'rent'>;
    contacted: Attribute.Boolean & Attribute.DefaultTo<false>;
    fav_users: Attribute.Relation<
      'api::property.property',
      'manyToMany',
      'plugin::users-permissions.user'
    >;
    contacted_users: Attribute.Relation<
      'api::property.property',
      'manyToMany',
      'plugin::users-permissions.user'
    >;
...
export interface ApiPropertyLocationPropertyLocation
  ...
  attributes: {
    name: Attribute.String;
    slug: Attribute.UID;
    propertiesNum: Attribute.Integer & Attribute.DefaultTo<0>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSearchSearch extends Schema.CollectionType {
...
export interface ApiSectionSection extends Schema.CollectionType {
  ...
  attributes: {
    ...
    precedence: Attribute.Integer & Attribute.Required & Attribute.DefaultTo<1>;
    container: Attribute.Component<'attributes.container'> & Attribute.Required;
    content: Attribute.DynamicZone<
      [
        'shared.breadcrumb',
        'shared.button-list',
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::company-submission.company-submission': ApiCompanySubmissionCompanySubmission;
